...
$firstname = explode(' ',trim($qwOrderData['testatorFullName']))[0];
...
<p>Your completed will is attached to this email.</p>
...
sendEmailAttachment($email, 'Your Will', $message, $finaldoc, $finaldocname);
